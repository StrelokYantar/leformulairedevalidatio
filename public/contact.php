...
if ($_POST) {
    // on stock les données des inputs dans un tableau 
    ...
    // si aucune erreurs n'est sur le tableau
    if (!$errors) {
        ...
        // on envoie le mail au destinataire et
        // on créer le transport
